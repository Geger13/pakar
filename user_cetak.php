...
if($_GET){
	...
	<?php 
		...
		<center><table width="1000" border="0" cellpadding="2" cellspacing="1" class="table-border"> 
		  <tr>
		    <td><center><img src="gambar/lobar.png" width="120" height="100" alt="gagal memuat gambar"></center></td>
		    <td><font size="5"><center>PEMERINTAH KABUPATEN LOMBOK BARAT<br>
		                               PUSKESMAS GERUNG
		                      </center></font>
                 <font size="2"><center>Alamat : Jalan Selaparang, Nomor 5, Kecamatan Gerung Kab. Lombok Barat Telp/Fax. 03706184422. Kode Pos 83363
		     		            </center></font>
		                      </td>
		  ...
		  <td width="750">&nbsp;</td>
		    <td colspan="3">
		       <div align="left"><font size="3">Mengetahui,<br><br><br><br><br><br>
		                                         <u>Ni Nyoman Sri Sukarthi, S.Keb., Bd.</u><br>
		                                         NIP. 1243579 201001 1 057
		                          </font></div>
		    </td>
		  </tr>
		</table></center>
